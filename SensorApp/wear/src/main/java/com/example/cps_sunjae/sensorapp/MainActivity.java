...
//        }
    ...
    public void sendSensorData(){
        ...
        for (int i = 0; i < accelT.size(); i++) {
            String accel = Long.toString(accelT.get(i)) + ", " +
        ...
        // Magnetometer
        try {
            outputStream.write("Magnetometer\n".getBytes());
        } catch (Exception e) {
            e.printStackTrace();
        }

        for (int i = 0; i < magT.size(); i++) {
            String mag = Long.toString(magT.get(i)) + ", " +
